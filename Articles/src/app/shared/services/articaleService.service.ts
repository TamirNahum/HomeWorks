import { Articale} from '../models/article.model';
...
export class ArticaleService{
    ...
    articaleFullList:Array<Articale>=[
        {
          "article_type": "Philosophic Article",
          "author_display": ["Eric Spana", "David M. MacAlpine", "Brian Oliver" ],
          "score": 8.7305155
      ...
      changeSelctedArticale(x:Articale):void{
        console.log("service:",this.selectedArticale);
        this.selectedArticale=x;
        console.log("service:",this.selectedArticale);

      }

      getSelctedArticale():Articale{
        return this.selectedArticale;
      }
}